...
(function(){
	...
	construct: function ( options )
	{
	    ...
	    this._container.stylize('zIndex',9900);
			
	    this.hide () ;
	    
	    this._destroyDel = ajsf.delegate(this,'_checkDestroy');
	    
	    ajsf.delayed(300, this._destroyDel, -1) ;
	},
	
	_checkDestroy: function ()
	{
	    if ( !this._input || !this._input.form.offsetParent )
	    {
		this.hide () ;
	    }
	},
	...
	destroy: function ()
	{
	    ajsf.undelayed(300, this._destroyDel, -1) ;
	    
	    this._destroyDel = null ;
